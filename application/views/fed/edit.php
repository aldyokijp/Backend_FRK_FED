    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Fed Edit</h3>
            </div>
			<?php echo form_open('fed/edit/'.$fed['fed_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="fed_frk_id" class="form-control">
								...
								{
									$selected = ($frk['frk_id'] == $fed['fed_frk_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="fed_tahun" class="form-control">
								...
								foreach($all_frk as $frk)
								{
									$selected = ($frk['frk_id'] == $fed['fed_tahun']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="fed_semester" class="form-control">
								...
								foreach($all_frk as $frk)
								{
									$selected = ($frk['frk_id'] == $fed['fed_semester']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="fed_status" class="form-control">
								...
								{
									$selected = ($value == $fed['fed_status']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="fed_ak" value="<?php echo ($this->input->post('fed_ak') ? $this->input->post('fed_ak') : $fed['fed_ak']); ?>" class="form-control" id="fed_ak" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="fed_kuan" class="control-label">Fed Kuan</label>
						<div class="form-group">
							<input type="text" name="fed_kuan" value="<?php echo ($this->input->post('fed_kuan') ? $this->input->post('fed_kuan') : $fed['fed_kuan']); ?>" class="form-control" id="fed_kuan" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="fed_kual" class="control-label">Fed Kual</label>
						<div class="form-group">
							<input type="text" name="fed_kual" value="<?php echo ($this->input->post('fed_kual') ? $this->input->post('fed_kual') : $fed['fed_kual']); ?>" class="form-control" id="fed_kual" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="fed_waktu" class="control-label">Fed Waktu</label>
						<div class="form-group">
							<input type="text" name="fed_waktu" value="<?php echo ($this->input->post('fed_waktu') ? $this->input->post('fed_waktu') : $fed['fed_waktu']); ?>" class="form-control" id="fed_waktu" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="fed_biaya" class="control-label">Fed Biaya</label>
						<div class="form-group">
							<input type="text" name="fed_biaya" value="<?php echo ($this->input->post('fed_biaya') ? $this->input->post('fed_biaya') : $fed['fed_biaya']); ?>" class="form-control" id="fed_biaya" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="fed_skp" class="control-label">Fed Skp</label>
						<div class="form-group">
							<input type="text" name="fed_skp" value="<?php echo ($this->input->post('fed_skp') ? $this->input->post('fed_skp') : $fed['fed_skp']); ?>" class="form-control" id="fed_skp" />
						</div>
					</div>
				</div>
			</div>
