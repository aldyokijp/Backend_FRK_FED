    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Matakuliah Add</h3>
            </div>
          		...
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="matakuliah_nama" value="<?php echo $this->input->post('matakuliah_nama'); ?>" class="form-control" id="matakuliah_nama" />
