    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Perguruan Tinggi Add</h3>
            </div>
            <?php echo form_open('perguruan_tinggi/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="pt_akreditasi_id" class="form-control">
								...
								{
									$selected = ($akreditasi['akreditasi_id'] == $this->input->post('pt_akreditasi_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="pt_nama" value="<?php echo $this->input->post('pt_nama'); ?>" class="form-control" id="pt_nama" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="pt_alamat" value="<?php echo $this->input->post('pt_alamat'); ?>" class="form-control" id="pt_alamat" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="pt_website" class="control-label">Pt Website</label>
						<div class="form-group">
							<input type="text" name="pt_website" value="<?php echo $this->input->post('pt_website'); ?>" class="form-control" id="pt_website" />
						</div>
					</div>
				</div>
			</div>
