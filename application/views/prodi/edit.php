    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Prodi Edit</h3>
            </div>
			<?php echo form_open('prodi/edit/'.$prodi['prodi_kode']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="prodi_akreditasi" class="form-control">
								...
								{
									$selected = ($akreditasi['akreditasi_id'] == $prodi['prodi_akreditasi']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="prodi_nama" value="<?php echo ($this->input->post('prodi_nama') ? $this->input->post('prodi_nama') : $prodi['prodi_nama']); ?>" class="form-control" id="prodi_nama" />
